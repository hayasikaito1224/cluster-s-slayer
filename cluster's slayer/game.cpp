...
CPlayerT	*CGame::m_PlayerT = nullptr;
...
HRESULT CGame::Init(void)
{
	...
	if (!m_pCommand)
	{
		m_pCommand = CCommandUI::Create(D3DXVECTOR3(800.0f, 550.0f, 0.0f), D3DXVECTOR3(40.0f, 15.0f, 0.0f), CTexture::L_BUTTON);
	}
	//敵のスポナーの生成
