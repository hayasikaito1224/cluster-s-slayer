...
HRESULT CRenderer::Init(HINSTANCE hInstance, HWND hWnd, bool bWindow)
{
	...
	// Set the fog color.
	m_pD3DDevice->SetRenderState(D3DRS_FOGCOLOR, D3DCOLOR_ARGB(255,250,250,250));
	...
	if (m_pCamera == nullptr )
	{
		...
		m_pCamera->Init();
		m_pCamera->SetViewport(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, 0);
		m_pCamera->SetAngleView(PLAYER_CAMERA_ANGLE_OF_VIEW);
...
void CRenderer::Draw(void)
{
	...
	if (SUCCEEDED(m_pD3DDevice->BeginScene()))
	{
		...
		m_pD3DDevice->SetViewport(&m_pCamera->GetViewport());
		// バックバッファ＆Ｚバッファのクリア
