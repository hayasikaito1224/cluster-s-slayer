...
//インスタンス生成処理
//---------------------------------------------------------------
CModel_Spawner *CModel_Spawner::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, const int nCreateModel, const int nCreateType)
{
	//デバイスのポインタ
	...
	{
		//モデルの生成
		pSpawner->m_pModel = CModel::Create(pos, D3DXVECTOR3(rot_x, rot_y, rot_z), nCreateModel, nCreateType);
		//親モデルをNULLに設定
