...
public:
	...
	void Update(void);
	void Draw(void);
	static CModel_Spawner *Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot,const int nCreateModel, const int nCreateType);//rotは角度を入れて
	...
	D3DXVECTOR3 GetSPos() { return m_pos; }
	D3DXVECTOR3 GetSRot() { return m_rot; }
